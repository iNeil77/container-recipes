FROM determinedai/pytorch-cpu-hpc:0.38.0 
# Ubuntu 20.04
...
# Setup Swift
RUN curl https://download.swift.org/swift-6.0.3-release/ubuntu2004/swift-6.0.3-RELEASE/swift-6.0.3-RELEASE-ubuntu20.04.tar.gz | tar xz -C /container/
ENV PATH="/container/swift-6.0.3-RELEASE-ubuntu20.04/usr/bin:${PATH}"
